...
export function getAllRoleNames(): { role: AgentRole; name: string }[] {
...
export const BENCHMARK_REQUIRED_ROLES: AgentRole[] = [
  "researcher",
  "inference-optimizer",
  "training-optimizer",
  "data-scientist",
...
export function requiresBenchmarking(role: AgentRole): boolean {
